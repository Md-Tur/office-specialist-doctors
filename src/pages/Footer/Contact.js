...
const Contact = () => {
    return (
        <div className='container mx-auto px-72 mb-5'>
            ...
            <p className='my-3 border text-lg font-bold text-center text-[#008000] text-lg text-center py-3 hover:underline hover:cursor-pointer'><Link to="/members">লিস্টের সবার উপরে আপনার প্রোফাইল রাখতে চাইলে ক্লিক করুন</Link></p>
