...
const SingleChestAsthma = () => {
    ...
    return (
        <div className='container mx-auto px-72'>
            ...
            <p className='my-3 border text-lg text-center text-[#2a7fba] py-3 hover:underline hover:cursor-pointer'><Link to="/chest-d">Chest Diseases Specialist in Dhaka</Link></p>
            ...
            <p className='border text-lg text-center py-3 my-3'>Updated on April 2, 2023</p>
        </div>
    );
};

export default SingleChestAsthma;