...
// images
import moarraf from '../../../../../images/Specialist/Dhaka/ChestAsthma/Prof.-Dr.-Md.-Moarraf-Hossen.jpg';

const ChestAsthmaDhaka = () => {
    ...
    return (
        <div className='container mx-auto px-72'>
            ...
            <p className='my-3 border text-3xl text-center text-black font-semibold py-3'>Chest Diseases Specialist Doctor in Dhaka</p>
            <p className='text-lg text-center border px-4 py-4'>A chest disease specialist or pulmonologist is a doctor who specializes in diagnosing & treating lung & <br />respiratory illnesses, which includes asthma, pneumonia, etc. Here in this page you can find out & choose the <br />best respiratory medicine specialist in Dhaka with their chamber information & contact number.</p>
            <p className='my-3 border text-3xl text-center text-black font-semibold py-3'>List of the Best Chest Diseases Specialist Doctor in Dhaka</p>
                    ...
                    <div key={doctor.id} className='border p-4 flex justify-center mb-3'>
                        <div className='flex flex-col justify-center'>
                            ...
                            <div className='flex flex-col text-center justify-center my-3'>
                                ...
                                <div>
                                    <button className='px-5 py-2 bg-[#2a7fba] rounded-md text-white text-xl font-normal hover:underline hover:bg-green-500'><Link to={`/dhaka-chestAsthma/${doctor.id}`}>See Details</Link></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default ChestAsthmaDhaka;