...
const SingleCancerSurgion = () => {
    ...
    return (
        <div className='container mx-auto px-72'>
            ...
            <p className='my-3 border text-lg text-center text-[#2a7fba] py-3 hover:underline hover:cursor-pointer'><Link to="/cancer-surgery-d">Surgical Oncologist in Dhaka</Link></p>
            ...
            <p className='border text-lg text-center py-3 my-3'>Updated on December 24, 2022</p>
        </div>
    );
};

export default SingleCancerSurgion;