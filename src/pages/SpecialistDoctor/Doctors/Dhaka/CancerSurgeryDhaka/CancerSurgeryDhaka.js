...
// images
import moarraf from '../../../../../images/Specialist/Dhaka/Cancer-Surgeon/Prof.-Dr.-Md.-Moarraf-Hossen.jpg';

const CancerSurgeryDhaka = () => {
    ...
    return (
        <div className='container mx-auto px-72'>
            ...
            <p className='my-3 border text-3xl text-center text-black font-semibold py-3'>Cancer Surgeon in Dhaka</p>
            <p className='text-lg text-center border px-4 py-4'>Cancer surgeon (surgical oncologist) is a surgeon who specializes in cancer surgery. Here in this page you can <br /> find out & choose the best cancer surgeon in Dhaka with their chamber information & contact number.</p>
            <p className='my-3 border text-3xl text-center text-black font-semibold py-3'>List of the Best Surgical Oncologist in Dhaka</p>
                    ...
                    <div key={doctor.id} className='border p-4 flex justify-center mb-3'>
                        <div className='flex flex-col justify-center'>
                            ...
                            <div className='flex flex-col text-center justify-center my-3'>
                                ...
                                <div>
                                    <button className='px-5 py-2 bg-[#2a7fba] rounded-md text-white text-xl font-normal hover:underline hover:bg-green-500'><Link to={`/dhaka-cancerSurgeon/${doctor.id}`}>See Details</Link></button>
                                </div>
                            </div>
                        </div>
                    </div>
...
export default CancerSurgeryDhaka;