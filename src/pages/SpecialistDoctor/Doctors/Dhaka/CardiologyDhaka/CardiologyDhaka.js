...
const CardiologyDhaka = () => {
    ...
    return (
        <div className='container mx-auto px-72'>
            ...
            <p className='my-3 border text-3xl text-center text-black font-semibold py-3'>Cardiologist in Dhaka</p>
            <p className='text-lg text-center border px-4 py-4'>Cardiologists are doctors who specialize in diagnosing & treating diseases or conditions of the heart & blood <br />vessels of cardiovascular system. Here in this page you can find out & choose the top 10 heart specialist doctor <br />in Bangladesh with their chamber information & contact number.</p>
            <p className='my-3 border text-3xl text-center text-black font-semibold py-3'>List of the Best Cardiologist in Dhaka</p>
                    ...
                    <div key={doctor.id} className='border p-4 flex justify-center mb-3'>
                        <div className='flex flex-col justify-center'>
                            ...
                            <div className='flex flex-col text-center justify-center my-3'>
                                ...
                                <div>
                                    <button className='px-5 py-2 bg-[#2a7fba] rounded-md text-white text-xl font-normal hover:underline hover:bg-green-500'><Link to={`/dhaka-cardiologist/${doctor.id}`}>See Details</Link></button>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <p className='border text-lg text-center py-3 my-3'>Updated on January 18, 2023</p>
        </div>
    );
};

export default CardiologyDhaka;